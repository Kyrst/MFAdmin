...
get('/core/get-dynamic-items/{id}', [ 'uses' => 'Core\DynamicItemController@getItems' ])->where('id', '[a-z_]+');

get('/dashboard', [ 'uses' => 'Dashboard\HomeController@home', 'as' => 'dashboard' ]);
//get('/dashboard/get-customers', [ 'uses' => 'Dashboard\Home\CustomersController@getCustomers', 'as' => 'dashboard/get-customers' ]);
